...
clear all; close all;
a_sim=readmatrix('Segway1_outputs.csv'); %analytical simulation data, file generated from python
p_sim=readmatrix('Segway1_webots.csv'); %physics simulation data, file generated from webots
